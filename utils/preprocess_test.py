...
def prepocess_test(workdir):
    ...
    from utils_preprocessing_test import to_float,number_sta_row,get_day,ker_Gauss,avg_weights,fill_nan_row, create_id
    ...
    X_concat = X_concat.swifter.apply(fill_nan_row, args = [X_concat, id_stations, dist_mat, 10], axis = 1, result_type='broadcast')
